...
<main class="device-frame">
  ...
  <section class="safe-area">
    ...
    <div class="section pt-3">
      <span class="badge-chip badge-prog">On-Progress</span>
      ...
      <div class="text-decoration-underline mt-2 mb-2 muted">10 June 2025, 9:41 WIB</div>
      <div class="hr-soft"></div>

      <div class="card-soft booster-row">
        <img src="{{ asset('assets/Images/pp.jpg') }}" class="avatar" alt="">
      ...
      <div class="card-soft">
        <div class="d-flex align-items-center gap-2">
          <img src="{{ asset('assets/Images/abyss.jpg') }}" class="thumb" alt="">
          <div>
            <div class="fw-bold">Genshin Impact | Abyss</div>
    ...
    <div class="action-bar">
      <div class="d-flex gap-2">
        ...
        <button class="btn btn-blue btn-pill w-50">Complete Order</button>
      </div>
    </div>
  </section>
